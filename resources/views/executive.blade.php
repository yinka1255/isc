                ...
                <form method="post" action="{{url('add_member')}}" id="contact-form">
                    <div class="row clearfix" style="margin: auto;width: 100%;">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="hidden" name="amount" id="inputAmount" value="40000" required>
                            
                            <div class="column col-md-12 text-center">
                                <div class="form-group">
                                    <button type="button" onclick="payWithPaystack()" class="theme-btn btn-style-one">Apply Now ($40,000)</button>
                                </div>
                            </div>
                        </div>
                    </div>
