            	...
            	<div class="row clearfix">
                	...
                	<div class="info-block col-md-4 col-sm-6 col-xs-12">
                    	<div class="inner-box">
                            ...
                            <h4>VISIT</h4>
                            234 Wellington Street, Ottawa <br> Ontario, Canada, K1A 0G9.
                        </div>
                    </div>
            	...
            	<div class="row clearfix">
                    ...
                    <div class="footer-column col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="footer-widget contact-widget">
                            <div class="footer-logo"><a href="index.html"><img src="{{asset('public/images/logo.png')}}"  class="header-logo" alt=""></a></div>
